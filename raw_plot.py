...
if __name__ == '__main__':
    ...
    parser.add_argument('-i', '--input', nargs='+', required=True, help='Path or paths to slow antenna files to plot')
    parser.add_argument('--use-notch-sixty', help='Specify this to use a 60 Hz notch filter', action='store_true')
    parser.add_argument('-o', '--output', help='Output path to save plots. If unspecified, plot will be opened in matplotlib show() window.', default=None)
